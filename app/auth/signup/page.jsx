...
const SignUp = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col dark:bg-dark-bg-primary">
      {/* Logo Header */}
      ...
      <div className="flex-1 flex flex-col justify-center px-6">
        <h1 className="text-2xl font-bold text-center mb-6 dark:text-dark-text-primary">Create an Account</h1>
        ...
        <form onSubmit={handleSubmit}>
          <div className="mb-4">
            <label htmlFor="fullName" className="block text-sm font-medium text-gray-700 mb-1 dark:text-dark-text-secondary">Full Name</label>
            <input
              type="text"
              id="fullName"
              name="fullName"
          ...
          <div className="mb-4">
            <label htmlFor="email" className="block text-sm font-medium text-gray-700 mb-1 dark:text-dark-text-secondary">Email Address</label>
            <input
              type="email"
              id="email"
              name="email"
          ...
          <div className="mb-6">
            <label htmlFor="password" className="block text-sm font-medium text-gray-700 mb-1 dark:text-dark-text-secondary">Password</label>
          ...
          <button 
            type="submit" 
            className="w-full bg-yellow-500 text-black font-medium py-3 rounded-lg mb-4 dark:hover:bg-dream-yellow-dark transition-colors"
          >
            Sign Up
          </button>
          </Link>
