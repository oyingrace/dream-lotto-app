          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="border rounded-lg overflow-hidden">
              <div className="h-24 relative">
                <Image
                  src="/images/lotto-balls-colorful.jpg"
                  alt="Premier 2-sure"
                  fill
                  className="object-cover"
                />
              ...
              <div className="p-3">
                ...
                <button className="w-full bg-yellow-500 text-white py-2 rounded-lg text-sm font-semibold">
                  Play Now
                </button>
              </div>
            </div>
